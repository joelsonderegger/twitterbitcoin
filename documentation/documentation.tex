...
The data analysis was performed with the statistical software STATA (version 14.2). The corresponding .dta file and .do file are stored in the folder stata\_analysis in the Github repository. Following, we describe all the commands used to produce our econometric model.
